...
def symmetric_linear() -> SymmetricLinear:
    ...
    return SymmetricLinear(features=4, bias=False)


@pytest.fixture
def spd_linear() -> SPDLinear:
    """SPDLinear layer of size 4."""
    return SPDLinear(features=4, bias=False, min_diag=1e-4)
...
def symmetric_factorized_linear() -> SymmetricFactorizedLinear:
    ...
    return SymmetricFactorizedLinear(features=4, bias=False)
