...
from dlkit.infrastructure.types.tilde_expansion import (
...
class TestIntegrationWithPydantic:
    ...
    def test_simple_tilde_path_annotation(self, tmp_path: Path) -> None:
        ...
        from dlkit.infrastructure.types import SimpleTildePath
    ...
    def test_simple_mlflow_uri_annotation(self, tmp_path: Path) -> None:
        ...
        from dlkit.infrastructure.types import SimpleMLflowURI
...
class TestNormalizeUrlPath:
    ...
    def test_adds_leading_slash(self) -> None:
        ...
        from dlkit.infrastructure.types.tilde_expansion import _normalize_url_path
...
class TestNormalizeFilePath:
    ...
    def test_unix_absolute_path(self) -> None:
        ...
        from dlkit.infrastructure.types.tilde_expansion import _normalize_file_path
