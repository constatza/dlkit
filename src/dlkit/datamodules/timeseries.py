	...
	def setup(self, stage: str | None = None) -> None:
		...
		if stage == 'fit' and not self.fitted:
			...
			dataset = TimeSeriesDataSet(
				...
				group_ids=self.dataset.raw.group_ids,
				target=self.dataset.raw.target,
				max_encoder_length=self.dataset.raw.encoder_length,
				max_prediction_length=self.dataset.raw.prediction_length,
				time_varying_known_reals=self.dataset.raw.time_varying_known_reals,
				time_varying_unknown_reals=self.dataset.raw.time_varying_unknown_reals,
				static_reals=self.dataset.raw.static_reals,
			)
