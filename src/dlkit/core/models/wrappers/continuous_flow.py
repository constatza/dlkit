...
from dlkit.core.models.wrappers.generative import GenerativeLightningWrapper

if TYPE_CHECKING:
    from dlkit.core.models.wrappers.protocols import IConfigurablePredictionStrategy
