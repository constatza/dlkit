...
- `dlkit.core.models.nn.base`: `ShapeAwareModel` for shape handling and precision
- `dlkit.core.shape_specs`: `IShapeSpec`, `NullShapeSpec` protocols
- `dlkit.core.models.nn.primitives`: `DenseBlock`, `SkipConnection` building blocks
...
```python
from dlkit.core.models.nn.ffnn import LinearNetwork, FeedForwardNN
from dlkit.core.shape_specs import create_shape_spec
import torch
...
```python
from dlkit.core.models.nn.ffnn import FeedForwardNN, NormScaledLinearFFNN
from dlkit.core.shape_specs import create_shape_spec, NullShapeSpec
import torch
...
### Test Coverage
- Unit tests: `tests/core/models/nn/test_ffnn.py` (to be created)
- Integration tests: `tests/integration/test_ffnn_training.py` (to be created)
...
## Related Modules
- `dlkit.core.models.nn.base`: `ShapeAwareModel` foundation
- `dlkit.core.models.nn.primitives`: `DenseBlock`, `SkipConnection` building blocks
- `dlkit.core.shape_specs`: Shape specification system
- `dlkit.core.models.wrappers`: Lightning wrappers for training FFNNs
