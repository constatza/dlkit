...
- `dlkit.core.models.nn.primitives.dense`: `DenseBlock` for fully connected layers
- `dlkit.core.models.nn.primitives.convolutional`: `ConvolutionBlock1d` for conv layers
- `dlkit.core.models.nn.primitives.skip`: `SkipConnection` for residual connections
- `dlkit.core.datatypes.networks`: `NormalizerName` type hints
...
**Example**:
```python
from dlkit.core.models.nn.encoder import SkipEncoder1d
import torch
...
**Example**:
```python
from dlkit.core.models.nn.encoder import SkipEncoder1d, SkipDecoder1d
import torch
...
**Example**:
```python
from dlkit.core.models.nn.encoder import VectorToTensorBlock
import torch
...
**Example**:
```python
from dlkit.core.models.nn.encoder import TensorToVectorBlock
import torch
...
```python
from dlkit.core.models.nn.encoder import (
    SkipEncoder1d,
    SkipDecoder1d,
    VectorToTensorBlock,
    TensorToVectorBlock
...
```python
from dlkit.core.models.nn.encoder import SkipEncoder1d, TensorToVectorBlock
...
### Test Coverage
- Unit tests: `tests/core/models/nn/test_encoder.py` (to be created)
...
## Related Modules
- `dlkit.core.models.nn.cae`: Uses encoder/decoder blocks for autoencoders
- `dlkit.core.models.nn.primitives`: Provides ConvolutionBlock1d, DenseBlock, SkipConnection
- `dlkit.core.models.nn.attention`: Can be combined with encoders for attention-based models
- `dlkit.core.models.nn.base`: Shape-aware model foundation
