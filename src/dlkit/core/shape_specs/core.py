...
class IShapeSpec(Protocol):
    """Protocol for shape specifications across all model types.

    This protocol defines the interface that all shape specifications must
    implement, enabling flexible shape handling for different model architectures
    ...
    def get_input_shape(self) -> tuple[int, ...] | None:
        ...
        Returns:
            Primary input shape tuple, or None if no input shape available.
        """
        ...
    ...
    def get_output_shape(self) -> tuple[int, ...] | None:
        ...
        Returns:
            Primary output shape tuple, or None if no output shape available.
        """
        ...
    ...
    def get_shape(self, name: str) -> tuple[int, ...] | None:
        ...
        Args:
            name: Name of the shape entry to retrieve.

        Returns:
            Shape tuple for the named entry, or None if not found.
        """
        ...
    ...
    def has_shape(self, name: str) -> bool:
        ...
        Args:
            name: Name of the shape entry to check.

        Returns:
            True if shape exists for the given name.
        """
        ...
    ...
    def get_all_shapes(self) -> dict[str, tuple[int, ...]]:
        ...
        Returns:
            Dictionary mapping entry names to shape tuples.
        """
        ...
    ...
    def with_canonical_aliases(self) -> IShapeSpec:
        """Return a spec that includes standard aliases (e.g. x/y) when possible."""
        ...
