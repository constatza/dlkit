...
Updates produce new instances via :func:`~dlkit.infrastructure.config.core.patching.patch_model`
...
class BasicSettings(BaseSettings):
    ...
    def update_with(self, updates: dict[str, Any], *, validate: bool = True) -> Self:
        ...
        Convenience wrapper around :func:`~dlkit.infrastructure.config.core.patching.patch_model`.
