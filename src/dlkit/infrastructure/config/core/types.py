"""Hyperparameter type aliases for model configuration fields.

These describe the shape of model settings fields: a plain value,
a search-space dict, or a discrete-options dict.
"""
