...
class PathContext:
    ...
    def empty(cls) -> PathContext:
        ...
        that relies entirely on fallback resolution (EnvironmentSettings, CWD).
...
def resolve_root_dir(
    ...
    Args:
        ...
        env: EnvironmentSettings instance (may be None). If provided, used as
    ...
    Example:
        ...
        >>> env = EnvironmentSettings()  # Reads DLKIT_ROOT_DIR
...
def resolve_component_path(
    ...
    Args:
        ...
        env: EnvironmentSettings instance (may be None). Used for root
            directory fallback.
