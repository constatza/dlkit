...
`dlkit.infrastructure.precision` provides semantic precision configuration, thread-safe runtime overrides, and a central resolution service. It has **no dlkit dependencies** — only torch and stdlib.
