...
- Components pre-built and injected via `RuntimeComponents` - executor doesn't construct dependencies
...
- `dlkit.runtime.workflows.factories.build_factory`: Component construction (`RuntimeComponents`)
...
from dlkit.tools.config import BuildFactory
from dlkit.tools.config import GeneralSettings
...
**Example**:
```python
from dlkit.runtime.execution import IOptimizationStrategy
from dlkit.tools.config import GeneralSettings
...
```python
from dlkit.runtime.execution import VanillaExecutor
from dlkit.runtime.tracking import TrackingDecorator, MLflowTracker
...
```python
from dlkit.runtime.execution import ITrainingExecutor
...
## Related Modules
- `dlkit.runtime.tracking`: Tracking decorators that wrap executors
