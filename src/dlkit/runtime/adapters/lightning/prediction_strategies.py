...
from dlkit.runtime.adapters.lightning.base import _batch_size_of, _leaf_device, _leaf_dtype

if TYPE_CHECKING:
    from dlkit.runtime.adapters.lightning.protocols import IBatchTransformer, IModelInvoker
...
class ODEPredictionStrategy:
    ...
    def predict(
        ...
        from dlkit.domain.nn.generative.functions.solvers import integrate
