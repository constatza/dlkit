...
from dlkit.runtime.adapters.lightning.generative import GenerativeLightningWrapper

if TYPE_CHECKING:
    from dlkit.runtime.adapters.lightning.protocols import IConfigurablePredictionStrategy
