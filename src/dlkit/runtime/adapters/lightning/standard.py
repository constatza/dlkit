...
from dlkit.runtime.adapters.lightning.protocols import IFittableBatchTransformer
...
from dlkit.tools.config.model_components import LossInputRef
...
class StandardLightningWrapper(ProcessingLightningWrapper):
    ...
    def configure_callbacks(self) -> list[Any]:
        ...
        """
        from dlkit.runtime.adapters.lightning.callbacks import TransformFittingCallback
