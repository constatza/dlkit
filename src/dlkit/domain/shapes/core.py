...
This module provides the lightweight ShapeSpec implementation with composition
of validation, serialization, and alias resolution strategies.
"""
...
class ValidationResult:
    ...
    def add_warning(self, warning: str) -> ValidationResult:
        ...
        Returns:
            New ValidationResult with warning added.
        """
    ...
    def failure(cls, errors: Iterable[str]) -> ValidationResult:
        ...
        Args:
            errors: Iterable of error messages.
...
class ShapeValidator:
    ...
    This class delegates to the specification-based validation engine
    for extensible and composable validation rules.
    """

    def __init__(self, validation_engine: Any | None = None) -> None:
    ...
    def get_validation_engine(self) -> Any:
...
class ShapeSerializer:
    ...
    def __init__(self, versioned_serializer: Any | None = None) -> None:
    ...
    def get_versioned_serializer(self) -> Any:
        """Get the underlying versioned serializer.

        Returns:
            The versioned serializer instance.
        """
        return self._versioned_serializer


# ---------------------------------------------------------------------------
# Alias resolver strategy
# ---------------------------------------------------------------------------
