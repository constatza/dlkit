...
**Example**:
```python
from dlkit.domain.nn.attention import TransformerEncoderBlock
import torch
...
- Default activation is ReLU, default dropout is 0.1
...
**Example**:
```python
from dlkit.domain.nn.attention import TransformerDecoderBlock
import torch
...
```python
from dlkit.domain.nn.attention import TransformerEncoderBlock, TransformerDecoderBlock
import torch
import torch.nn as nn
...
### Test Coverage
- Unit tests: `tests/core/models/nn/test_attention.py`
...
## Related Modules
- `dlkit.domain.nn.primitives`: Building blocks used in feedforward parts of transformers
- `dlkit.domain.nn.encoder`: Encoder/decoder architectures that may use attention
- `dlkit.domain.nn.cae`: Autoencoders that could benefit from attention mechanisms
