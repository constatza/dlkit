...
- `dlkit.domain.nn.base`: `ShapeAwareModel` base class for shape handling
...
**Example**:
```python
from dlkit.domain.nn.cae.vae import reparameterize
import torch
...
### Test Coverage
- Unit tests: `tests/core/models/nn/test_cae.py`
...
## Related Modules
- `dlkit.domain.nn.encoder`: Encoder/decoder building blocks used by CAEs
