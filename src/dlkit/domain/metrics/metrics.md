...
**Example**:
```python
from dlkit.domain.metrics import IMetric, create_metric
import torch
...
**Example**:
```python
from dlkit.domain.metrics.base import BaseMetric
...
**Example**:
```python
from dlkit.domain.metrics import create_metric
import torch
...
**Example**:
```python
from dlkit.domain.metrics import MeanSquaredErrorMetric, create_metric
import torch
...
**Example**:
```python
from dlkit.domain.metrics import create_normalized_vector_norm_error
import torch
...
**Example**:
```python
from dlkit.domain.metrics import create_metric, create_composite_metric
import torch
...
### Test Coverage
- Unit tests: `tests/core/training/metrics/`
